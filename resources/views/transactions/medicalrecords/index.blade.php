                                 ...
                                 @foreach ($transactions as $transaction) 
                                    <tr>
                                        ...
                                        <td class="td-actions text-right">
                                            @if ($transaction->enccode)
                                                <a href="{{ route('medicalrecords.show', str_replace("/","-",$transaction->enccode)) }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="More details">
                                                    <i class="tim-icons icon-zoom-split"></i>
                                                </a>
                                            @elseif ($transaction->enccode)
                                                <a href="{{ route('transfer.show', $transaction->enccode) }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="More details">
                                                    <i class="tim-icons icon-zoom-split"></i>
                                                </a>
                                            @else
