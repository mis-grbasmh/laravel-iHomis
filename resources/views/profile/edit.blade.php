                ...
                <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                    <div class="card-body">
                            ...
                            <div class="form-group{{ $errors->has('employeeid') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="employeeid" class="form-control{{ $errors->has('employeeid') ? ' is-invalid' : '' }}" placeholder="employeeid" value="{{ old('employeeid', auth()->user()->employeeid) }}" disabled>
                                @include('alerts.feedback', ['field' => 'employeeid'])
                            </div>
                            <div class="form-group{{ $errors->has('username') ? ' has-danger' : '' }}">
                                <label>Username</label>
                                <input type="text" name="username" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" placeholder="Username" value="{{ old('username', auth()->user()->username) }}">
