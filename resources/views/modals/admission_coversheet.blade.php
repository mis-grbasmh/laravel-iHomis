<div class="modal-dialog modal-lg" role="dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            @csrf
            <input type="hidden" class="form-control" id="css_id" name="enccode" disabled>
            <div class="modal-body ">
                @csrf
            <div class="form-group">
                <label><strong>Patient Name:</strong></label>
                <input type="text" class="form-control" id="css_name"" disabled>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label><strong>Type of Admisson:<span class="required">*</span></strong></label>
                     <select class="form-control" id="edit_tacode" name="tacode">
                ...
                <div class="form-group col-md-6">
                        ...
                        {{-- @foreach(servicecasetypes() as $servicetype)
            ...
            <div class="form-group">
                ...
                <textarea rows="4" id="edit_admnotes" name="admnotes" aria-required="true" aria-invalid="false" class="form-control no-resize" placeholder="Please type reason for admission...">
                </textarea>
            ...
            <div class="form-group">
                ...
                <textarea rows="6" id="edit_admtxt" name="admtxt" required="" aria-required="true" aria-invalid="false" class="form-control no-resize" placeholder="Please type admitting diagnosis...">
                </textarea>
